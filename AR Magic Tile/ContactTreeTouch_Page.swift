...
class ContactTreeTouch : UIViewController {
...
District 10230
"""),Contact(Icon: #imageLiteral(resourceName: "phone").withRenderingMode(.alwaysTemplate), Header: "Phone", Description: "+662 379 9065"),Contact(Icon: #imageLiteral(resourceName: "email").withRenderingMode(.alwaysTemplate), Header: "Email", Description: "cherrythe3touch@gmail.com"),Contact(Icon: #imageLiteral(resourceName: "Line").withRenderingMode(.alwaysTemplate), Header: "Line", Description: "@thethreetouch")]
    ...
    var Im_Logo : UIImageView = {
        ...
        image.image = #imageLiteral(resourceName: "Logo-TheThreeTouch_1000x1000").withRenderingMode(.alwaysOriginal)
    ...
    var Lb_NameWisdom : UILabel = {
        let label = UILabel()
        label.text = "The TreeTouch Asia Pacific Co.,Ltd"
 ...
 """
    ...
    func Layout_Page(){
        ...
        // Set StackView
        let Stackview = UIStackView(arrangedSubviews: [View_Top, View_Logo, View_Contact, View_Link])
...
extension ContactTreeTouch : UICollectionViewDelegate, UICollectionViewDataSource {
...
extension ContactTreeTouch : UICollectionViewDelegateFlowLayout {
